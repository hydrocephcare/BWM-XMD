      ...
      <div className="container mx-auto px-4">
        ...
        >
          <motion.div variants={item}>
            <Card className="h-full border-gray-200 transition-all duration-200 hover:shadow-md hover:border-navy-200">
              ...
              <CardFooter>
                <Button className="w-full bg-navy-600 hover:bg-navy-700 group">
                  <Link
          ...
          <motion.div variants={item}>
            <Card className="h-full border-navy-300 relative transition-all duration-200 hover:shadow-md">
              ...
              <CardFooter>
                <Button className="w-full bg-gold-500 hover:bg-gold-600 text-navy-900 group">
                  <Link
                    href="https://wa.link/jox26j"
                    target="_blank"
                    className="flex items-center justify-center w-full"
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm flex flex-col items-center text-center">
            ...
            <p className="text-sm text-gray-600">
              Well-designed database with proper relationships, normalization, and optimized queries for efficient data
              management.
            </p>
          </div>
