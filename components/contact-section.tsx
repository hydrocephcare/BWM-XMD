...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-navy-50">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <Badge className="mb-4 bg-navy-200 text-navy-700 hover:bg-navy-300">Get In Touch</Badge>
          <h2 className="text-3xl md:text-4xl font-bold text-navy-800 mb-4">Contact Us</h2>
        ...
        >
          <div className="bg-white rounded-lg p-6 shadow-sm">
            ...
            <form className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-navy-600 hover:bg-navy-700 group">
                Send Message
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-navy-700">Phone</h4>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-navy-700">Email</h4>
              ...
              <div className="pt-6 mt-6 border-t border-gray-200">
                <h4 className="text-sm font-semibold text-navy-700 mb-4">Connect With Us</h4>
                <div className="flex space-x-4">
                  <Link
                    href="#"
                    className="h-10 w-10 rounded-full bg-navy-100 flex items-center justify-center hover:bg-navy-200 transition-colors"
                  >
